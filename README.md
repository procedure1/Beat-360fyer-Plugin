...
|`BrightLights`| Brightens low key lights (whether generated by this plugin or not). (default = `true`)|
...
||90|
|`ShowGenerated90`| `true` If you want to enable 90 degree mode generation. Requires restart for maps that have already been selected in the menu. (default = `false`)|
